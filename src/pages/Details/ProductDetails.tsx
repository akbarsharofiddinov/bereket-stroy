...
const ProductDetails: React.FC = () => {
  ...
  useEffect(() => {
    if (productDetails?.data.length) {
      getComments();
      setSeo(productDetails.data[0].seo)
  ...
  return (
    <>
      <div className="product-details-page">
        {productDetails?.data.length && seo ? (
          <>
            {/* <Helmet> */}
            ...
            <div
              className={
                fixedToTop ? "fixed-product_info active" : "fixed-product_info"
              }
            >
              <div className="container">
                <div className="left">
                  <div className="img-box">
                    <img
                      src={`http://bereket.webclub.uz/storage/${productDetails.data[0].photos[0]}`}
                      alt="bereket-strop_photo"
                    />
                  </div>

                  <div className="body">
                    <h2 className="name">{productDetails.data[0].name}</h2>
